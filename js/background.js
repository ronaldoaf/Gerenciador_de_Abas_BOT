	...
	setInterval(function(){		
		...
		if (bot_ligado){
			...
			chrome.tabs.query({},function(tabs){			
				...
				if (!includes_list(tab_urls, 'Goalline') ) chrome.tabs.create({url:'https://mobile.allsport365.com/#type=Coupon;key=151014714C1_1_3;Goalline'});
				if (!includes_list(tab_urls, 'MyBets') ) chrome.tabs.create({url:'https://mobile.allsport365.com/#type=MyBets;key=;ip=0;lng=1'});
